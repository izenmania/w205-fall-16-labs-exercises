...
You will be working with data from the [Centers for Medicare and Medicaid Services (CMS) Hospital Compare](https://data.medicare.gov/data/hospital-compare) project. You can
download the entire dataset as flat comma-separated files [here](https://data.medicare.gov/views/bg9k-emty/files/cd0ad057-efd8-4557-9f70-8fb132ae3dcc?content_type=application%2Fzip%3B%20charset%3Dbinary&filename=Hospital_Revised_FlatFiles.zip). A description of the various files is provided in the [data dictionary](https://data.medicare.gov/views/bg9k-emty/files/5440a626-3030-41cc-8531-8aae0b3902ef?filename=DDB_Data_Dictionary_October_2016_Final.pdf&content_type=application%2Fpdf%3B%20charset%3Dbinary).
...
| hvbp_hcahps_05_28_2015.csv | Example survey response data | surveys_responses.csv |
